...
class AdvancedRadarSimulationEngine:
    ...
    def __init__(self, config: SimulationConfig):
        ...
        self.signal_processor = AdvancedSignalProcessor(
            sampling_rate=config.radar_bandwidth,
    ...
    def update_tracking_system(self, fusion_result: Dict[str, Any]) -> None:
        ...
        if fused_state is not None:
            ...
            self.state.tracks = [t for t in self.state.tracks 
    ...
    def calculate_received_power(self, rcs: float, range_distance: float, 
    ...
    def add_target(self, position: np.ndarray, velocity: np.ndarray, 
                  target_type: str = 'aircraft', rcs: float = 1.0) -> None:
        """Hedef ekler"""
        # Dtype casting hatasını önlemek için float64'e dönüştür
